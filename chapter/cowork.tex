...
\textbf{构建规则：}\cmd{Makefile} 定义了三个主要产物：\cmd{termsync\_server}、\cmd{termsync\_client} 和 \cmd{test\_termsync}。公共模块会被同时链接到服务端、客户端和测试程序，客户端额外链接 \cmd{ncursesw}。

\inputminted[firstline=1,lastline=42,firstnumber=1]{make}{code/cowork/Makefile}
